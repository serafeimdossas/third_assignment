...
public class DriverOptions {
    ...
    private DriverOptions setValueDependentOptions(DriverOption opt, Object value) {
        if (value == null)
            return this;
        switch (opt) {
        case DEFINE:
    ...
    public DriverOptions set(DriverOption opt, Object value) {
        ...
        case CLI_ARGS:
        case CHROME_EXTENSION:
            if (setValueDependentOptions(opt, value) != null)
                return setValueDependentOptions(opt, value);
            break;
        case ALERTS_POLICY:
